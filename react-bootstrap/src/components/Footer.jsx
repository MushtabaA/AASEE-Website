        ...
        <div class="main-footer">
            <div class ="container">
                <div class="row">
                    {/* Logo Coulmn */}
               <div class = "col">
                 <img class="img-fluid" src="/assets/colorLogo.png" width="100%"></img>
               </div>
               {/* Coulmn1 */}
               <div class = "col">
               ...
               <div class = "col">
                ...
                <div class = "col">
                   ...
                   <ul class="list-unstyled">
                    ...
                    <li> <a href="mailto:aaseeproject@gmail.com"><img src="./assets/Mail Logo Flat.png" class="pb-1 size-2 img-fluid fa" width="20%"></img></a></li>
                   </ul>
               </div>
               <hr/>
                </div>
